...
def test_main_with_source_encoding_option(mock_convert_to_markdown: Mock) -> None:
    ...
    mock_convert_to_markdown.assert_called_once_with(test_html, autolinks=False, bullets="*+-", code_language="", convert=None, convert_as_inline=False, default_title=False, escape_asterisks=True, escape_misc=True, escape_underscores=True, extract_metadata=True, heading_style="underlined", highlight_style="double-equal", keep_inline_images_in=None, list_indent_type="spaces", list_indent_width=4, newline_style="spaces", preprocess_html=False, preprocessing_preset="standard", remove_forms=True, remove_navigation=True, strip=None, strip_newlines=False, strong_em_symbol="*", sub_symbol="", sup_symbol="", whitespace_mode="normalized", wrap=False, wrap_width=80)
