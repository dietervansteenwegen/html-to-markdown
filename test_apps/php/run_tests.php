...
// alef:hash:fb15a85038d3c8b10b4ce720b096d011953f9428bb35cbc79c53fb8cc4e2e224
...
if (version_compare($loadedVersion, '3.12.3', '<')) {
    ...
    fwrite(STDERR, "  expected version: >=3.12.3\n");
